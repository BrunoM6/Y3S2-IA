...
def genetic_algorithm(population, generations, fitness_func, folder_path, video_size, problem_description, dataset, mutation_rate=0.2, tournament_size=3, elitism=True):
    max_json_number = 0
    folder_path_scores = os.path.join(folder_path, "scores")
    folder_path_scores = os.path.join(folder_path_scores, dataset)
